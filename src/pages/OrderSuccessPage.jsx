...
return( 
        ...
        <div className="text-center">
          ...
          <p className="mt-6 text-base leading-7 text-gray-600">You can check order in my account > My orders</p>
          <div className="mt-10 flex items-center justify-center gap-x-6">
            ...
            {/* like there should be some page but it is not there so you can do contact support  */}
