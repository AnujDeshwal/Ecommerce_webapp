...
const CheckOut = () => {
  ...
  const handleOrder = (e) => {
    const order = {
      ...
      paymentMethod,
      selectedAddress,
      status: "pending", //othere status can be delivered,received ,they would be selected by admin
    };
...
{/* if user selects cash then no need of stripe because stripe helps in online payment so just go to order succes page  */}
...
{/* but if user selects card means now need of stripe comes now stripe waali cheeje  */}
      ...
      {user && <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="mx-auto mt-5 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              <div className="border-t lg:px-0 border-gray-200 mt-7 py-4 sm:px-6">
                ...
                <div onClick={handleOrder} className="mt-6">
                  <NavLink className="flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700">
                    Pay and Order
                  </NavLink>
                </div>
